                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        ...
                        <div class="card card-primary w-100">
                            ...
                            <!-- form start -->
                            <form action="edit.php?product_id=<?php echo $product['id'] ?>" method="post" enctype="multipart/form-data">
                                <div class="card-body">
                                    <div class="form-group">
                                        <label for="product_name">Tên sản phẩm:</label>
                                        <input type="text" class="form-control" id="product_name" name="product_name" placeholder="Tên sản phẩm" value="<?php echo $product['name'] ?>" required />
                                    </div>
                                    <div class="form-group">
                                        <label for="price">Giá tiền:</label>
                                        <input type="number" class="form-control" id="price" name="price" placeholder="Giá tiền" value="<?php echo $product['price'] ?>" required />
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            <div class="custom-file">
                                                ...
                                                <label class="custom-file-label" for="image" name='image_name'><?php echo $product['image'] ?></label>
                                            </div>
                                        </div>
                                        <img src='../../uploads/images/<?php echo $product['image'] ?>' id="output" class="m-2" width="100" height="100" />
                                    </div>
                                    <div class="form-group">
                                        <label for="feature_sum">Tóm tắt tính năng:</label>
                                        <textarea type="text" class="form-control" id="feature_sum" name="feature_sum" rows="10" required><?php echo br2nl($product['feature_sum']) ?></textarea>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            <div class="custom-file">
                                                ...
                                                <label class="custom-file-label" for="srs_file" name='srs_name'><?php echo $product['srs_file'] ?></label>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <select class="form-control select2" style="width: 100%;" id='category_id' name='category_id'>
                                            <option value="0" <?php echo $temp_category_id == 0 ? 'selected="selected"' : '' ?>>Không</option>
                                            <?php
                                            $conn = connectToDB();
                                            ...
                                            ?>
                                                <option value="<?php echo $row['id'] ?>" <?php echo $row['id'] == $temp_category_id ? 'selected="selected"' : '' ?> title="<?php echo $row['description'] ?>"><?php echo $row['name'] ?></option>
                                            <?php
                                            }
                                            $conn = null; ?>
                                        </select>
