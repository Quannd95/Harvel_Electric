                    ...
                    <div class="row">
                        ...
                        <div class="card card-primary w-100">
                            ...
                            <form action="create.php" method="post">
                                <div class="card-body">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="shop_name" name="shop_name" placeholder="Tên shop" required />
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="owner" name="owner" placeholder="Chủ shop" required />
                                    </div>
                                    <div class="form-group">
                            ...
                            if (isset($_POST['submit'])) {
                                ...
                                $owner = $_POST['owner'];
                                $email = $_POST['email'];
                                $query = "insert into shops(name, address, owner, email) values('$name', '$address', '$owner', '$email')";
