                ...
                <div class="card-header">
                  ...
                  <div class="form-group">
                                        <select class="form-control select2" style="width: 100%;" id='parent_id' name='parent_id'>
                                            ...
                                            <?php
                                            $conn = connectToDB();
                                            $query = "Select * from products where not exists (select product_id from product_shop WHERE products.id = product_shop.product_id AND product_shop.id='". $_GET['shop_id'] ."' )";
