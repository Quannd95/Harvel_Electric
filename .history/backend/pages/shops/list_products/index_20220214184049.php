            ...
            <div class="col-12">
              ...
              <div class="card">
                <div class="card-header">
                  ...
                  <form class="form-group" method="post" action="add_product.php">
                    ...
                    <select class="form-control select2" style="width: 100%;" id='parent_id' name='parent_id'>
                                            ...
                                            ?>
                                                <option value="<?php echo $row['id'] ?>" title="<?php echo $row['price'] ?>" name="product"><?php echo $row['name'] ?></option>
                                            <?php
                                            }
                                            $conn = null; ?>
                                        </select>
                    <!-- </form> -->
                    <input type="submit" class="btn btn-success float-right" value="+ Thêm sản phẩm">
                  </form>
                </div>
                <!-- /.card-header -->
                <div class="card-body">
